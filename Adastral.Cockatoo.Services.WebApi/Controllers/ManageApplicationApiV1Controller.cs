...
public class ManageApplicationApiV1Controller(IServiceProvider services) : Controller()
{
    ...
    private readonly ManageApplicationWebService _manageAppWebService = services.GetRequiredService<ManageApplicationWebService>();
        ...
        [ModelBinder(typeof(JsonModelBinder))] [FromBody] ManageApplicationV1CreateRequest requestData)
    {
        ...
        var result = await _manageAppWebService.CreateApplication(requestData);
